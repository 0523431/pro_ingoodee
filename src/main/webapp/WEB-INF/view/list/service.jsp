...
<div class="wrap" id="wrap">
		...
		<div class="service-area service-area01">
		야근 때문에, 시간이 없어서,<br>
		거리가 멀어서, 그냥 귀찮아서...<br><br>
		팍팍한 삶 속 취미 한 스푼을 더해,<br>
		여유롭고 아름다운 일상을 즐기고 싶었지만<br>
		취미를 즐기지 못할 이유는 왜 그렇게나 많았을까요?
		</div>
		<div class="service-area service-area02">
		...
		<div class="service-area04-01">
		<strong>쉽고 편리한<br>취미배송 서비스</strong>
		평소에 즐기고 싶었던 취미를 고르기만 하세요!<br>취미 클래스가 여러분의 방으로 찾아갑니다.
		</div>
		...
		취미 아티스트가 자세하게 과정을 설명해 드리는<br>클래스 영상으로 누구든 쉽게 취미를 시작할 수 있어요.
		</div>
		</div>
