				...
				<div class="join-type-wrap">
					<div class="float-wrap">
						<div class="join-type-cont">
								...
								<a href="${kakao_url}">
								<button title="카카오톡으로 로그인"
									class="btn-join-type btn-join-kakaotalk">
						...
						<form:form modelAttribute="user" method="post" name="login" onsubmit="return check()" action="../user/login.shop">
							<!-- submit보내면 가는곳 -->
							<div class="join-type-cont">
								<ul class="login-email-wrap">
									<li class="login-email"><input type="email" id="emailid"
										name="emailid" class="login-input" placeholder="아이디 (이메일)" />
									</li>
									<li class="login-email"><input type="password" id="pass"
										name="pass" class="login-input" placeholder="비밀번호"></li>
									<li class="login-keep">
					...
					<div class="float-wrap">
						<div class="login-find-wrap">
							<ul class="login-find-list">
								...
								<li class="login-find"><a href="#findpassword"
									title="비밀번호 찾기" class="btn-login-find btn-find-pw">비밀번호 찾기</a></li>
							</ul>
						</div>
						<div class="login-bottom-wrap"
							data-gtm-vis-recent-on-screen-6759522_106="4107"
							data-gtm-vis-first-on-screen-6759522_106="4107"
							data-gtm-vis-total-visible-time-6759522_106="100"
							data-gtm-vis-has-fired-6759522_106="1">
							아직 하비풀 회원이 아니신가요? <a href="#join" title="회원가입"
								class="link-join a-join showjoin">회원가입</a>
						</div>
					</div>
				</div>
