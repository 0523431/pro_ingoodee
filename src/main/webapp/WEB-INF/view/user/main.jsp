			...
			<ul class="als-wrapper swiper-wrapper panel">
				...
				<li class="als-item swiper-slide" style="width: 220.25px; margin-right: 18px;">
					<a href="/product/906965c18d">
						...
						<p class="i-desc">
							<span class="i-type">정규 클래스1</span>
				...
				<li class="als-item swiper-slide" style="width: 220.25px; margin-right: 18px;">
					<a href="/product/traveldigital">
						...
						<p class="i-desc">
							<span class="i-type">정규 클래스222222</span>
				...
				<li class="als-item swiper-slide" style="width: 220.25px; margin-right: 18px;">
					<a href="/product/QMeAha5VgU">
						...
						<p class="i-desc">
							<span class="i-type">정규 클래스333333333</span>
				...
				<li class="als-item swiper-slide" style="width: 220.25px; margin-right: 18px;">
					<a href="/product/92LvaquM5a">
						...
						<p class="i-desc">
							<span class="i-type">DIY 키트44444444</span>
				...
				<li class="als-item swiper-slide" style="width: 220.25px; margin-right: 18px;">
					<a href="/product/Bo2uDp6tLZ">
						...
						<p class="i-desc">
							<span class="i-type">원데이 클래스5555555555555555555</span>
