	...
	<div class="container">
		...
		<div class="profile-wrap">
			...
			<div class="profile-info-wrap">
				안녕하세요.
				<div class="profile-name cut-txt">${user.nickname}</div>
		...
		<div class="my-info-wrap">
			<ul class="my-info-list">
				...
				<strong class="my-info-txt my-level">${user.grade==1? "Thanksful":user.grade==2? "wonderful":"hobbyful"}</strong>
				</li>
				<li class="my-info">
				...
				<a href="javascript:;"><strong class="my-info-txt cut-txt my-point" onclick="$('.btn-mymenu-action-history').trigger('click');  $('.sub-menu-mileage').trigger('click')">${user.mileage}p</strong></a>
				</li>
			</ul>
		</div>
		</div>
